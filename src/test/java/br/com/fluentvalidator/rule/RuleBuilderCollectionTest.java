...
public class RuleBuilderCollectionTest {
    ...
    public void testSuccessInvalidMultipleRuleWithoutCritical() {
        ...
        builder.must(hasSize(2)).when(not(nullValue())).withMessage("test").must(hasSize(2)).when(not(nullValue())).withMessage("test").must(hasSize(1)).when(not(nullValue()))
    ...
    public void testSuccessInvalidSingleRuleWithCriticalException() {
        ...
        builder.must(hasSize(2)).when(not(nullValue())).withMessage("test").critical(ValidationSampleException.class);
    ...
    public void testFailInvalidSingleRuleWithCriticalException() {
        ...
        builder.must(hasSize(1)).when(not(nullValue())).withMessage("test").critical(ValidationSampleException.class);
    ...
    public void testFailInvalidMultipleWithCriticalException() {
        ...
        builder.must(hasSize(2)).when(not(nullValue())).withMessage("test").must(hasSize(2)).when(not(nullValue())).withMessage("test").must(hasSize(1)).when(not(nullValue()))
                .withMessage("test").critical(ValidationSampleException.class).must(hasSize(2)).when(not(nullValue())).withMessage("test");
