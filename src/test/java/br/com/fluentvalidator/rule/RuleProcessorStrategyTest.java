...
public class RuleProcessorStrategyTest {
    ...
    public void testFailFastFailMultipleRulesWithCritical() {
        ...
        stringValidationRule1.withMessage("Rule non critical 1");
        ...
        stringValidationRuleCritical.withMessage("Rule critical 1");
        ...
        stringValidationRule2.withMessage("Rule non critical 2");
