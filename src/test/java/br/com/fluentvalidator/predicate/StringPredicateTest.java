...
public class StringPredicateTest {
	...
	public void testNullObjectStringSize2() {
		...
		assertFalse(
		        stringSize(ObjectFrom<String>::getSource, (Integer) null).test(new ObjectFrom<String>("hello", null)));
	...
	public void testNullObjectStringSizeGreaterThan2() {
		...
		assertFalse(stringSizeGreaterThan(ObjectFrom<String>::getSource, (Integer) null)
		        .test(new ObjectFrom<String>("hello", null)));
		assertFalse(
		        stringSizeGreaterThan(ObjectFrom<String>::getSource, 5).test(new ObjectFrom<String>(null, "hello")));
		assertFalse(stringSizeGreaterThan(ObjectFrom<String>::getSource, (Integer) null)
		        .test(new ObjectFrom<String>(null, null)));
	}
	...
	public void testNullObjectStringSizeGreaterThanOrEqual() {
		assertFalse(
		        stringSizeGreaterThanOrEqual(ObjectFrom<String>::getSource, ObjectFrom<String>::getTarget).test(null));
		assertFalse(stringSizeGreaterThanOrEqual(ObjectFrom<String>::getSource, ObjectFrom<String>::getTarget)
		        .test(new ObjectFrom<String>("hello", null)));
		assertFalse(stringSizeGreaterThanOrEqual(ObjectFrom<String>::getSource, ObjectFrom<String>::getTarget)
		        .test(new ObjectFrom<String>(null, "hello")));
		assertFalse(stringSizeGreaterThanOrEqual(ObjectFrom<String>::getSource, ObjectFrom<String>::getTarget)
	...
	public void testNullObjectStringSizeLessThanOrEqual() {
		...
		assertFalse(stringSizeLessThanOrEqual(ObjectFrom<String>::getSource, ObjectFrom<String>::getTarget)
		        .test(new ObjectFrom<String>("hello", null)));
		assertFalse(stringSizeLessThanOrEqual(ObjectFrom<String>::getSource, ObjectFrom<String>::getTarget)
		        .test(new ObjectFrom<String>(null, "hello")));
		assertFalse(stringSizeLessThanOrEqual(ObjectFrom<String>::getSource, ObjectFrom<String>::getTarget)
	...
	public void testObjectIsAlpha() {
		...
		assertFalse(isAlpha(ObjectFrom<String>::getSource).test(new ObjectFrom<String>("-123", null)));
		assertFalse(isAlpha(ObjectFrom<String>::getSource).test(new ObjectFrom<String>("1.23E3", null)));
		assertFalse(isAlpha(ObjectFrom<String>::getSource).test(new ObjectFrom<String>("1.23E+3", null)));
		assertFalse(isAlpha(ObjectFrom<String>::getSource).test(new ObjectFrom<String>("12.3E+7", null)));
		...
		assertFalse(isAlpha(ObjectFrom<String>::getSource).test(new ObjectFrom<String>("0.00123", null)));
		assertFalse(isAlpha(ObjectFrom<String>::getSource).test(new ObjectFrom<String>("-1.23E-12", null)));
		assertFalse(isAlpha(ObjectFrom<String>::getSource).test(new ObjectFrom<String>("1234.5E-4", null)));
	...
	public void testObjectIsAlphaNumeric() {
		assertTrue(isAlphaNumeric(ObjectFrom<String>::getSource).test(new ObjectFrom<String>("ABCDEF", null)));
		assertTrue(isAlphaNumeric(ObjectFrom<String>::getSource).test(new ObjectFrom<String>("abcdef", null)));
		assertTrue(isAlphaNumeric(ObjectFrom<String>::getSource).test(new ObjectFrom<String>("abcdef123456", null)));
		assertFalse(isAlphaNumeric(ObjectFrom<String>::getSource).test(new ObjectFrom<String>("", null)));
		assertTrue(isAlphaNumeric(ObjectFrom<String>::getSource).test(new ObjectFrom<String>("0", null)));
		assertFalse(isAlphaNumeric(ObjectFrom<String>::getSource).test(new ObjectFrom<String>("0.00", null)));
		assertTrue(isAlphaNumeric(ObjectFrom<String>::getSource).test(new ObjectFrom<String>("123", null)));
		assertFalse(isAlphaNumeric(ObjectFrom<String>::getSource).test(new ObjectFrom<String>("-123", null)));
		assertFalse(isAlphaNumeric(ObjectFrom<String>::getSource).test(new ObjectFrom<String>("1.23E3", null)));
		assertFalse(isAlphaNumeric(ObjectFrom<String>::getSource).test(new ObjectFrom<String>("1.23E+3", null)));
		assertFalse(isAlphaNumeric(ObjectFrom<String>::getSource).test(new ObjectFrom<String>("12.3E+7", null)));
		assertFalse(isAlphaNumeric(ObjectFrom<String>::getSource).test(new ObjectFrom<String>("12.0", null)));
		assertFalse(isAlphaNumeric(ObjectFrom<String>::getSource).test(new ObjectFrom<String>("12.3", null)));
		assertFalse(isAlphaNumeric(ObjectFrom<String>::getSource).test(new ObjectFrom<String>("0.00123", null)));
		assertFalse(isAlphaNumeric(ObjectFrom<String>::getSource).test(new ObjectFrom<String>("-1.23E-12", null)));
		assertFalse(isAlphaNumeric(ObjectFrom<String>::getSource).test(new ObjectFrom<String>("1234.5E-4", null)));
		assertFalse(isAlphaNumeric(ObjectFrom<String>::getSource).test(new ObjectFrom<String>("0E+7", null)));
		assertFalse(isAlphaNumeric(ObjectFrom<String>::getSource).test(new ObjectFrom<String>("-0", null)));
	}

	@Test
	public void testObjectIsNumber() {
		assertFalse(isNumeric(ObjectFrom<String>::getSource).test(new ObjectFrom<String>("ABCDEF", null)));
		...
		assertTrue(isNumber(ObjectFrom<String>::getSource).test(new ObjectFrom<String>("-123", null)));
		assertTrue(isNumber(ObjectFrom<String>::getSource).test(new ObjectFrom<String>("1.23E3", null)));
		assertTrue(isNumber(ObjectFrom<String>::getSource).test(new ObjectFrom<String>("1.23E+3", null)));
		assertTrue(isNumber(ObjectFrom<String>::getSource).test(new ObjectFrom<String>("12.3E+7", null)));
		...
		assertTrue(isNumber(ObjectFrom<String>::getSource).test(new ObjectFrom<String>("0.00123", null)));
		assertTrue(isNumber(ObjectFrom<String>::getSource).test(new ObjectFrom<String>("-1.23E-12", null)));
		assertTrue(isNumber(ObjectFrom<String>::getSource).test(new ObjectFrom<String>("1234.5E-4", null)));
		assertTrue(isNumber(ObjectFrom<String>::getSource).test(new ObjectFrom<String>("0E+7", null)));
		assertTrue(isNumber(ObjectFrom<String>::getSource).test(new ObjectFrom<String>("-0", null)));
		assertFalse(isNumber(ObjectFrom<String>::getSource).test(new ObjectFrom<String>("1234.5E-4EE", null)));
	}
	...
	public void testObjectNulltStringSizeBetween() {
		...
		assertFalse(
		        stringSizeBetween(ObjectFrom<String>::getSource, null, null).test(new ObjectFrom<String>("xo", null)));
	...
	public void testObjectStringContains() {
		assertTrue(stringContains(ObjectFrom<String>::getSource, "lo").test(new ObjectFrom<String>("hello", null)));
		assertFalse(stringContains(ObjectFrom<String>::getSource, "xo").test(new ObjectFrom<String>("hello", null)));
		assertFalse(stringContains(ObjectFrom<String>::getSource, "xo").test(new ObjectFrom<String>(null, null)));
		assertFalse(stringContains(ObjectFrom<String>::getSource, "xo").test(null));
	}

	@Test
	public void testObjectNullStringEqualsIgnoreCase() {
		assertFalse(stringEqualsIgnoreCase(ObjectFrom<String>::getSource, ObjectFrom<String>::getTarget).test(null));
	...
	public void testObjectStringEqualsIgnoreCase() {
		...
		assertTrue(stringEqualsIgnoreCase(ObjectFrom<String>::getSource, "hello")
		        .test(new ObjectFrom<String>("hello", null)));
		assertFalse(
		        stringEqualsIgnoreCase(ObjectFrom<String>::getSource, "xo").test(new ObjectFrom<String>("xoo", null)));
	}
	...
	public void testObjectStringEmptyOrNull() {
		...
		assertFalse(stringEmptyOrNull(ObjectFrom<String>::getSource).test(new ObjectFrom<String>("o", null)));
	}

	@Test
	public void testObjectStringMatches() {
		assertTrue(stringMatches(ObjectFrom<String>::getSource, "^h.*o$").test(new ObjectFrom<String>("hello", null)));
		assertFalse(stringMatches(ObjectFrom<String>::getSource, "^x$").test(new ObjectFrom<String>("hello", null)));
		assertFalse(stringMatches(ObjectFrom<String>::getSource, "^x$").test(new ObjectFrom<String>(null, null)));
	...
	public void testObjectStringSizeBetween() {
		assertTrue(
		        stringSizeBetween(ObjectFrom<String>::getSource, 0, 6).test(new ObjectFrom<String>("hell", "hello")));
		assertTrue(
		        stringSizeBetween(ObjectFrom<String>::getSource, 0, 5).test(new ObjectFrom<String>("hell", "hello")));
		assertFalse(
		        stringSizeBetween(ObjectFrom<String>::getSource, 6, 0).test(new ObjectFrom<String>("hell", "hello")));
	}
	...
	public void testObjectStringSizeGreaterThan2() {
		assertTrue(
		        stringSizeGreaterThan(ObjectFrom<String>::getSource, 4).test(new ObjectFrom<String>("hello", "hell")));
		assertFalse(
		        stringSizeGreaterThan(ObjectFrom<String>::getSource, 5).test(new ObjectFrom<String>("hello", "hello")));
		assertFalse(
		        stringSizeGreaterThan(ObjectFrom<String>::getSource, 5).test(new ObjectFrom<String>("hell", "hello")));
	}

	@Test
	public void testObjectStringSizeGreaterThanOrEqual() {
		assertTrue(stringSizeGreaterThanOrEqual(ObjectFrom<String>::getSource, ObjectFrom<String>::getTarget)
		        .test(new ObjectFrom<String>("hello", "hell")));
		assertTrue(stringSizeGreaterThanOrEqual(ObjectFrom<String>::getSource, ObjectFrom<String>::getTarget)
		        .test(new ObjectFrom<String>("hello", "hello")));
		assertFalse(stringSizeGreaterThanOrEqual(ObjectFrom<String>::getSource, ObjectFrom<String>::getTarget)
	...
	public void testObjectStringSizeLessThan2() {
		...
		assertFalse(
		        stringSizeLessThan(ObjectFrom<String>::getSource, 5).test(new ObjectFrom<String>("hello", "hello")));
	...
	public void testObjectStringSizeLessThanOrEqual() {
		assertTrue(stringSizeLessThanOrEqual(ObjectFrom<String>::getSource, ObjectFrom<String>::getTarget)
		        .test(new ObjectFrom<String>("hell", "hello")));
		assertTrue(stringSizeLessThanOrEqual(ObjectFrom<String>::getSource, ObjectFrom<String>::getTarget)
		        .test(new ObjectFrom<String>("hello", "hello")));
		assertFalse(stringSizeLessThanOrEqual(ObjectFrom<String>::getSource, ObjectFrom<String>::getTarget)
