...
abstract class AbstractRuleBuilder<T, P, W extends When<T, P, W>> implements When<T, P, W>, Must<T, P, W>, Message<T, P, W>, FieldName<T, P, W>, Code<T, P, W>, Critical<T, P, W>, WithValidator<T, P, W>, Rule<T> {
